...
def add_msg_to_gpt_conv(context: CallbackContext, role: str, content: str):
    context.user_data['gpt_conv'].append({'role': {role}, 'content': {content}})
...
def main():
    ...
    conv_handler = ConversationHandler(
        ...
        states={
            ...
            DIAGNOSE: [MessageHandler(filters.Text and filters.Regex(r'^(?!/)'), validate_diagnose)]
        },
