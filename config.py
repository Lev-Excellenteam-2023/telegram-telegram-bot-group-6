class Config:
    ...
    MAX_TOKENS = 500
    TIMEOUT = 2
    TEMPLATE_PREFIX_TO_OPENAI = "Hi openai, the user grows plans, but there is a disease there." \
    ...
    # For Telegram bot
    with open(r'C:\Networks\telegram-telegram-bot-group-6\telegram_bot\.env', "r") as file:
    ...
    SERVICE_ACCOUNT_KEY = r'C:\Networks\telegram-telegram-bot-group-6\firebase\telegrambot-365e7-firebase-adminsdk-fc7ki-3ade0542c6.json'
